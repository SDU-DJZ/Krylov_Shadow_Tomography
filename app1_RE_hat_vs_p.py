...
repeat_num = 1
# Generate p
p_list=np.linspace(0, 0.9, points_num)
...
def calculate_errors(i):
    ...
    for j in range(points_num):        
        rho = mf.generate_GHZ_type_dm(p_list[j], N)
        # Exact value of QFI
...
if __name__ == "__main__":
    ...
    if os.path.exists('numerical_results_app1_p.json'):
    ...
    with open('numerical_results_app1_p.json', 'w', encoding='utf-8') as file:
